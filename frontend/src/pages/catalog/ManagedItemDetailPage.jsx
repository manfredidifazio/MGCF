  ...
  return (
    <PageMask icon={Icon} title={item.name} description={config.summary(item)}>
      <div className="rounded-lg border border-gray-300 bg-white p-8">
        ...
        <Link to={config.settingsPath} className="mt-8 inline-flex rounded-md border border-gray-300 px-4 py-2 text-sm text-slate-700 transition-colors hover:bg-slate-50">
