...
const inputClass =
  "mt-2 w-full rounded-md border border-gray-300 bg-white px-4 py-3 text-slate-700 outline-none transition-colors focus:border-indigo-500";
    ...
    >
      ...
      <div className="mt-8 flex justify-end gap-3">
        ...
        <button
          type="submit"
          disabled={saving}
          className="rounded-md bg-indigo-600 px-6 py-3 font-semibold text-white shadow-sm transition-colors hover:bg-indigo-500 disabled:opacity-60"
        >
