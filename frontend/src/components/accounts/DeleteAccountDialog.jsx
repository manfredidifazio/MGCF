...
export default function DeleteAccountDialog({ account, deleting, onCancel, onConfirm }) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-900/40 p-6 backdrop-blur-sm">
      <div className="w-full max-w-md rounded-xl border border-gray-300 bg-white p-8">
        ...
        <div className="mt-8 flex justify-end gap-3">
          <button
            ...
            onClick={onCancel}
            disabled={deleting}
            className="rounded-lg border border-gray-300 px-5 py-3 font-semibold text-slate-700 transition hover:bg-slate-50 disabled:opacity-60"
          >
            Annulla
          </button>
          <button
